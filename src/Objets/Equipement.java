...
public abstract class Equipement extends Objets {
    protected Equipement (String nom, String description, int Poids){
        super(nom, description, Poids);
    }

    public static ArrayList<Equipement> initEquipement(){
        ...
        listeEquipement.add(new Arme("Couteau-suisse", "Un outil polyvalent qui sert à la" +
